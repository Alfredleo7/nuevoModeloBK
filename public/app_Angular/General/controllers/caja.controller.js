...
angular.module('general').controller('CajasBorradorCtrl', ['$scope','$http','$routeParams','$location','Caja_Detalles',
  function($scope, $http, $routeParams, $location, Caja_Detalles) {
    ...
    $scope.deleteCaja = function(cajas, caja) {
      (new PNotify({
          title: 'Confirmación',
    ...
    $scope.enviarCaja = function(cajas, caja) {
      (new PNotify({
          title: 'Confirmación',
