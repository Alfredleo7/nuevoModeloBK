    ...
    var b = function() {
            ...
            return function() {
                    ...
                    return c.prototype.render = function(b) {
                        var c = b.call(this),
                            d = a('<span class="select2-search select2-search--dropdown input-group"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" /><a id="select2Agregar" href="#" onclick="enviarValorSelect2($(\'.select2-search__field\').val())">Agregar<i class="fa fa-check"></i></a></span>');
